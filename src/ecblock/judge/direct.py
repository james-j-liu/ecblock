...
Rate a single anonymized excerpt from a European Central Bank Governing Council speech,
...
- +100 = maximally HAWKISH: strong concern about inflation/overheating, urging tighter
  policy, higher rates, faster/longer restriction, balance-sheet reduction.
-    0 = NEUTRAL / balanced.
- -100 = maximally DOVISH: concern about growth/employment/disinflation, urging looser
  policy, rate cuts, prolonged accommodation, asset purchases.

CRITICAL - score RELATIVE to the macroeconomic conditions given. Urging vigilance on
inflation when HICP is at 2.0% is meaningfully hawkish; identical language when HICP is at
8.5% is merely stating the obvious and should score closer to neutral. Calibrate to context.
